...
Official documentation explains _what_ a service does. It rarely explains _when_ to choose it, and almost never explains when not to.
...
#### [Azure Architecture Decision Guides](azure-architecture-decision-guides.md)
...
#### [Kubernetes References](kubernetes-references.md)
