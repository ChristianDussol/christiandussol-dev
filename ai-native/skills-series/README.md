...
All three Skills are open source in the [kyverno repository](https://github.com/christian-dussol-cloud-native/kyverno/tree/main/skills), licensed CC BY-SA 4.0, and [runnable with setup scripts](../../labs/the-agentic-layer.md). The experiments are public and the things that didn't work are part of the record.
